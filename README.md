...
## 🧠 Your 30-minute teaching sequence

I would teach your two topics in this order:
...
11. Service Management
          ↓
12. /etc/passwd connection
```

This way students don't just memorize `yum install`, `yum remove`, `yum update`, `yum list`, and `yum info`; they understand **why package management exists and what actually happens when they install software**.
